...
local myScript = sdk2.Register:New("Tekken HEIHACHI","\xef\x93\x9a")
local outModule = {}
		...
		if isCounterAttackPossible(FrameAdvantage) then
			...
			if AttackType == enums.AttackType.MID then
				...
				if FrameAdvantage == 19 then
					executeMacro(enums.Input.DOWN ,0, 2, enums.InputType.KEY_PRESS)
					executeMacro(enums.Input.DOWN + enums.Input.FORWARD,0, 5, enums.InputType.KEY_DOWN)
				...
				if FrameAdvantage == 18 or FrameAdvantage == 17 or FrameAdvantage == 16 or FrameAdvantage == 15 then
					...
					executeMacro(0,enums.Input.L_HAND+enums.Input.R_HAND, 1, enums.InputType.KEY_PRESS)
					executeMacro(0,enums.Input.L_HAND, 5, enums.InputType.KEY_PRESS)
					executeMacro(0,enums.Input.L_HAND, 5, enums.InputType.KEY_PRESS)
				end
				--OK
...
myScript:onMenu(function()
    ...
    menu.text('HEIHACHI Combo Test Script Demo')
    menu.sameLine()
