...
local myScript = sdk2.Register:New("Tekken LARS","\xef\x93\x9a")
local outModule = {}
...
myScript:onMenu(function()
    ...
    menu.text('LARS Combo Test Script Demo')
    menu.sameLine()
    ...
    menu.text("It allows for automatic blocLARS and punishments with customizable chances.")
