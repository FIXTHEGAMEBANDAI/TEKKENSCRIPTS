...
local myScript = sdk2.Register:New("Tekken King","\xef\x93\x9a")
local outModule = {}
		...
		if isCounterAttackPossible(FrameAdvantage) then
			...
			if AttackType == enums.AttackType.MID then
				...
				if FrameAdvantage == 17 then
					...
					executeMacro(enums.Input.DOWN, enums.Input.R_HAND, 5, enums.InputType.KEY_PRESS)
					return
				end
				--OK
...
myScript:onMenu(function()
    ...
    menu.text('King Combo Test Script Demo')
    menu.sameLine()
